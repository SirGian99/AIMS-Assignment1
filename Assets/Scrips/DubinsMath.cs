...
public class DubinsMath : MonoBehaviour
{
    ...
    public static UnityStandardAssets.Vehicles.Car.CarController m_Car;

    public static float turningRadius { get { return velocity / angularVelocity; } }
       
        public static Vector3 RightCircleCenter(Vector3 carPos, float heading)
    {
    ...
    public static Vector3 LeftCircleCenter(Vector3 carPos, float heading)
    {
